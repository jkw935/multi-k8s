...
kubectl set image deployments/client-deployment server=jkw5/multi-client:$SHA
kubectl set image deployments/worker-deployment server=jkw5/multi-worker:$SHA
